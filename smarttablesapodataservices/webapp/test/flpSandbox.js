		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ProductSet",
									"targetURL": "#comprodsetsmarttablesapodataservices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprodsetsmarttablesapodataservices-display": {
								"semanticObject": "comprodsetsmarttablesapodataservices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.prod.set.smarttablesapodataservices",
									"url": sap.ui.require.toUrl("com/prod/set/smarttablesapodataservices")
								}
							}
						}
					}
